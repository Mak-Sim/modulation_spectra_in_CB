...
xlabel('Модуляционная частота, {\it Гц}');
ylabel('Номер критической полосы');
title({'Модуляционный спектр', '(ДПФ с объединением полос)'});
...
xlabel('Модуляционная частота, {\it Гц}');
ylabel('Номер критической полосы');
title({'Модуляционный спектр','(неравнополосный банк фильтров)'});
